...
CREATE SEQUENCE SEQ_RENTAL_NO START WITH 20230001 NOCACHE;

CREATE TABLE RENTAL (
  RENT_NO NUMBER(10) DEFAULT(SEQ_RENTAL_NO.NEXTVAL) PRIMARY KEY NOT NULL,
  ...
  OVERDUE_STATE NUMBER(10),
  CONSTRAINT UQ_RENTAL_NO UNIQUE (NO)
);
...
SELECT 1 FROM RENTAL WHERE NO='230016';


UPDATE RENTAL SET OVERDUE_STATE = TRUNC(DUE_DATE - SYSDATE) ;


ALTER TABLE RENTAL ADD OVERDUE_STATE NUMBER(10) NOT NULL;

ALTER TABLE RENTAL ADD OVERDUE_STATE NUMBER(10);
...
UPDATE RENTAL SET REN_DATE = TO_DATE('230611', 'YY/MM/DD'), DUE_DATE = TO_DATE('230614', 'YY/MM/DD') WHERE NO = '230016' ;
...
ALTER TABLE RENTAL
MODIFY OVERDUE_STATE NUMBER(10) GENERATED ALWAYS AS (DUE_DATE - SYSDATE) VIRTUAL NOT NULL;



DELETE FROM RENTAL WHERE RENT_NO='230011';
