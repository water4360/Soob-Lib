...
SELECT * FROM L_REPLY; --댓글
SELECT * FROM L_BOARD; --게시글 & 답글
...
--메인 게시글
SELECT NO, WRITER, TITLE, CONTENT, TO_CHAR(REG_DATE, 'yy-mm-dd') REG_DATE
, HIT, REF, LEV, STEP FROM L_BOARD ORDER BY NO DESC;
    
INSERT INTO T_REPLY(NO, BOARD_NO, CONTENT, WRITER) 
    VALUES(SEQ_REPLY_NO.NEXTVAL, 23, '테스트 댓글2', 'guest');
COMMIT;

SELECT * FROM L_BOARD WHERE NO = 1;
...
CREATE TABLE L_BOARD(
    ...
    , REG_DATE DATE DEFAULT TO_CHAR(SYSDATE, 'yy-mm-dd')
...
INSERT INTO L_BOARD(NO, WRITER, TITLE, CONTENT, REG_DATE) 
    ...
    INSERT INTO L_BOARD(NO, WRITER, TITLE, CONTENT) VALUES(99, '1111', '2222', '3333');
    SELECT * FROM L_BOARD;
    UPDATE L_BOARD SET TITLE = 11, CONTENT = 33 WHERE NO = 99;
    ROLLBACK;